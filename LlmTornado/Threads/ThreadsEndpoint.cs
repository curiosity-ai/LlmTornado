...
public sealed class ThreadsEndpoint : EndpointBase
{
    ...
    public Task<HttpCallResult<TornadoThread>> CreateThread(
    ...
    /// <param name="cancellationToken">Optional, <see cref="CancellationToken"/>.</param>
    /// <returns><see cref="TornadoThread"/>.</returns>
    public Task<HttpCallResult<TornadoThread>> RetrieveThread(
        string             threadId,
        CancellationToken? cancellationToken = null)
    {
    ...
    /// <param name="cancellationToken">Optional, <see cref="CancellationToken"/>.</param>
    /// <returns><see cref="TornadoThread"/>.</returns>
    public Task<HttpCallResult<TornadoThread>> ModifyThread(
        string              threadId,
    ...
    public async Task<HttpCallResult<bool>> DeleteThread(
        string             threadId,
        CancellationToken? cancellationToken = null)
    {
    ...
    public Task<HttpCallResult<AssistantMessage>> CreateMessage(
        string               threadId,
    ...
    public Task<HttpCallResult<ListResponse<AssistantMessage>>> ListMessages(
        string            threadId,
    ...
    /// <param name="cancellationToken">Optional, <see cref="CancellationToken"/>.</param>
    /// <returns><see cref="AssistantMessage"/>.</returns>
    public Task<HttpCallResult<AssistantMessage>> RetrieveMessage(
        string            threadId,
        string            messageId,
        CancellationToken cancellationToken = default)
    {
    ...
    /// <param name="cancellationToken">Optional, <see cref="CancellationToken"/>.</param>
    /// <returns><see cref="AssistantMessage"/>.</returns>
    public Task<HttpCallResult<AssistantMessage>> ModifyMessage(
        string               threadId,
        string               messageId,
    ...
    public async Task<HttpCallResult<bool>> DeleteMessage(
        string             threadId,
        string             messageId,
        CancellationToken? cancellationToken = null)
    {
    ...
    public Task<HttpCallResult<TornadoRun>> CreateRun(
        string             threadId,
    ...
    public Task<HttpCallResult<TornadoRun>> CreateThreadAndRun(
    ...
    public Task<HttpCallResult<TornadoRun>> RetrieveRun(
        string             threadId,
        string             runId,
        CancellationToken? cancellationToken = null)
    {
    ...
    public Task<HttpCallResult<List<TornadoRun>>> ListRuns(
        string            threadId,
        ListQuery?        query             = null,
        CancellationToken cancellationToken = default)
    {
    ...
    public Task<HttpCallResult<TornadoRun>> ModifyRun(
        string            threadId,
        string            runId,
    ...
    public Task<HttpCallResult<ListResponse<TornadoRunStep>>> ListRunSteps(
        string            threadId,
        string            runId,
        ListQuery?        query             = null,
        CancellationToken cancellationToken = default)
    ...
    public Task<HttpCallResult<TornadoRunStep>> RetrieveRunStep(
        string            threadId,
        string            runId,
        string            runStepId,
        CancellationToken cancellationToken = default)
    ...
    public Task<HttpCallResult<TornadoRun>> SubmitToolOutput(
        string                   threadId,
        string                   runId,
